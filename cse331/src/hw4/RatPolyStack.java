...
public final class RatPolyStack implements Iterable<RatPoly> {
   ...
   */
  public void swap() {
	// pop two elements out and then push it back it in reverse order
  ...
  public void differentiate() {
    RatPoly p = this.polys.pop();
    this.polys.push(p.differentiate());
  }
  ...
  public void integrate() {
    RatPoly p = this.polys.pop();
    this.polys.push(p.antiDifferentiate(RatNum.ZERO));
  }
